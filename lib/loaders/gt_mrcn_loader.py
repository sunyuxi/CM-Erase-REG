...
class GtMRCNLoader(Loader):
  ...
  def getBatch(self, split, opt):
    ...
    for image_id in batch_image_ids:
      ...
      for ref_id in ref_ids:
        ...
        head_pool5, _ = self.load_img_to_spatial_fc7(image_id) 
    ...
    img_pool5 = torch.cat(batch_head_pool5, 0); img_pool5.detach_()
    pos_fc7   = torch.cat(batch_pos_fc7, 0); pos_fc7.detach_() 
    pos_pool5 = torch.cat(batch_pos_pool5, 0); pos_pool5.detach_()
    ...
    neg_fc7   = torch.cat(batch_neg_fc7, 0); neg_fc7.detach_()
    neg_pool5 = torch.cat(batch_neg_pool5, 0); neg_pool5.detach_()
  ...
  def getTestBatch(self, split, opt):
    ...
    head_pool5, _ = self.load_img_to_spatial_fc7(image_id) # actually here we use pool5 features. I was too lazy to revise the name. #_# ...
    batch_head_pool5 = []
