...
def main(args):
  ...
  if 'rsvg' in dataset_splitBy:
    det_feats_input_dir = 'data/rsvg/hbb_obb_features_selectedrefnms_det'
  else:
  ...
  dets_json = osp.join('cache/detections', dataset_splitBy, 'matt_dets_att_vanilla_refnms_rsvg_0.json')
  ...
  # feats_h5
  file_name = 'refnms_%s_%s_%s_det_feats.h5' % (args.net_name, args.imdb_name, args.tag)
